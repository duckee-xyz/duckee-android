...
import xyz.duckee.android.core.domain.collection.GetCollectionBoughtUseCase
...
@HiltViewModel
internal class CollectionBoughtViewModel @Inject constructor(
    private val getMyProfileUseCase: GetMyProfileUseCase,
    private val getCollectionBoughtUseCase: GetCollectionBoughtUseCase,
    ...
    fun onResume() = intent {
        if (collectionDataManager.reloadState.value) {
            ...
            getArtFeed()
            collectionDataManager.invalidatePendingReloadState()
        }
    }
